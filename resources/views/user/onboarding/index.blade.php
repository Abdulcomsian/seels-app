...
<div class="MainContentBody w-full p-4 bg-[#f0f1f6]">
    ...
    <main class="w-full max-w-xl mx-auto flex flex-col items-center">
      <div
        class="bg-white w-full shadow rounded-[26px] py-8 px-5 md:px-20 text-center mb-8"
      >
        <h1 class="text-[20px] font-bold text-[#1B1B1F]">
          Lorem ipsum dolor
        </h1>
        <p
          class="text-[14px] leading-22.4 font-normal text-[#46464F] pt-[8px]"
        >
      ...
      >
        <div class="flex-1">
          ...
          <p
            class="text-[14px] leading-22.4 text-[#46464F] max-w-[262px]"
          >
        ...
        <span
          class="bg-[#F3C941] text-[#000000] text-[16px] font-semibold max-h-[49px] w-[188px] py-3 px-5 text-center rounded-full w-[188px]"
          >The Seels Scan</span
        >
      </div>
      ...
      <div class="bg-white w-full shadow rounded-[26px] py-8 px-5 mb-8">
        <h1
          class="text-[24px] font-bold text-[#333333] leading-36 flex items-center gap-6"
        >
        ...
        <div class="email mt-6">
          <label
            for="email"
            class="block text-base leading-24 text-[#333333] mb-2"
            >Email</label
          >
          <input
            type="email"
      ...
      <div class="bg-white w-full shadow rounded-[26px] py-8 px-5 mb-8">
        <h1
          class="text-[24px] text-[#333333] font-bold leading-36 flex items-center gap-6"
        >
        ...
        <div class="email mt-6">
          <label
            for="email"
            class="block text-[#333333] text-base leading-24 text-[#333333] mb-2"
            >Email</label
          >
          <input
            type="email"
