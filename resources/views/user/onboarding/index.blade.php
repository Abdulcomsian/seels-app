...
<div class="MainContentBody w-full p-4 bg-[#f0f1f6]">
    ...
    <main class="w-full max-w-xl mx-auto flex flex-col items-center">
        ...
        @foreach($accountDetails as $index => $emailDetail) 
                <div id="email-groups-wrapper" class="mt-6">
                    <div class="email-group mb-6 border p-4 rounded-lg">
                        <label class="block text-base leading-24 text-[#333333] mb-2">Email</label>
                        ...
                        <label class="block text-base leading-24 text-[#333333] mb-2 mt-4">Email Type</label>
                        ...
                        <div class="relative">
                            ...
                            <button type="button"
                                class="absolute top-1/2 right-3 transform -translate-y-1/2 text-gray-500 password-toggle"
