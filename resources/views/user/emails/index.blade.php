        ...
        <div class="border m-6 mt-4 rounded-lg p-4">
            <div class="flex items-center justify-between border-b pb-4">
                <div class="flex items-center space-x-2 ml-3">
                    ...
                    <!-- <span class="text-[21px] font-semibold"> Email </span> -->
                    <input type="text" id="emailIdss" class="text-[21px] font-semibold border border-gray-300 rounded px-2 py-1" value="{{ $emailFormat[1]->email_name ?? 'Email 2' }} " required readonly />
