        ...
        <div class="border m-6 mt-4 rounded-lg p-4">
            <div class="flex items-center justify-between border-b pb-4">
                <div class="flex items-center space-x-2 ml-3">
                    ...
                    <!-- <span class="text-[21px] font-semibold"> Email </span> -->
                    <input type="text" id="emailIds" class="text-[21px] font-semibold border border-gray-300 rounded px-2 py-1" value="" required readonly />
        ...
        <div class="border m-6 mt-4 rounded-lg p-4">
            <div class="flex items-center justify-between border-b pb-4">
                <div class="flex items-center space-x-2 ml-3">
                    ...
                    <!-- <span class="text-[21px] font-semibold"> Email </span> -->
                    <input type="text" id="emailIdss" class="text-[21px] font-semibold border border-gray-300 rounded px-2 py-1" value="" required readonly />
                ...
                <div class="w-full pl-3 leading-normal lg:w-7/12 lg:pr-4">
                    <div class="border-b pb-4">
                        <p class="font-semibold text-sm">
                            ...
                            <span id="subjectss" class="font-normal text-sm px-1">
                                {{ 'Potential for expansion abroad' }}
                            </span>
                        </p>
                    </div>

                    <p id="descriptionss" class="mt-2 pb-3 px-1 text-sm leading-normal">
                        {{ 'I hope you had a wonderful summer holiday. I noticed that you have posted over SNIPPET1 ads in SNIPPET2. This prompted me to ask the following question.' }}
                    </p>
...
<script>
    ...
    // $("#send-btnss").click(function() {
    //     let messageText = $("#message-inputss").val(); // Corrected ID
    //     if (messageText.trim() === "") {
    //         toastr.error("Message cannot be empty!");
    //         return;
    //     }

    //     let emailFormatIds = document.getElementById('emailFormatIdss').value;
    //     $.ajax({
    //         url: "{{ route('sendMessage') }}",
    //         type: "POST",
    //         headers: {
