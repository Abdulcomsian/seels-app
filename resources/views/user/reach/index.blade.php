...
<div class="MainContentBody w-full p-5 bg-[#f0f1f6]">
    ...
    <div class="bg-white shadow w-full">
      <!-- <div
          class="flex flex-col md:flex-row justify-between items-center p-8 pb-9"
        >
          <div class="flex items-center flex-wrap space-x-4">
            <span class="text-[#182151] text-[18px] font-semibold">
              All Campaigns
            </span>
            ...
            <div class="relative">
              <button class="text-gray-600 flex items-center">
                ...
                <span class="pl-[9px] pr-[3px] text-[18px] text-[#000000]"
                  >Folders</span
                >
          ...
          <div
            class="flex items-center flex-wrap gap-[13px] py-3 md-w-[359px] md:h-[35px]"
          >
            <div
            ...
            <button
              class="flex items-center space-x-1 px-4 py-2 bg-[#FBF8FD] text-gray-400 rounded-lg"
            >
      ...
      <div
        class="flex flex-col md:flex-row justify-between md:items-center p-4 md:p-8 md:pb-9"
      >
        <!-- Left Section -->
        <div class="flex items-center flex-wrap space-x-4">
          <span class="text-[#182151] text-[18px] font-semibold"
          ...
          <div class="relative">
            ...
            <!-- Dropdown Menu -->
            <div
              id="folderDropdownMenu"
              class="hidden absolute bg-white shadow-md rounded-lg mt-2 w-40 z-10"
            >
              <ul>
        ...
        <!-- Right Section -->
        <div
          class="flex items-center flex-wrap gap-[13px] w-auto pt-6 md:pt-0 md:w-[359px] md:h-[35px]"
        >
          <div
            class="flex items-center justify-between border border-gray-300 rounded-lg px-3 py-2 bg-white h-[40px] max-w-[260px]"
          >
      ...
      <div class="overflow-x-auto">
        <table class="bg-white">
          <thead>
            <tr
              class="w-full text-[#000000] font-normal capitalize text-sm leading-normal border-b border-t"
            >
          ...
          <tbody class="text-gray-600 text-sm font-light">
            ...
            <tr class="border-gray-200 hover:bg-gray-100">
              <td class="py-3 text-left whitespace-nowrap border-r">
                <div class="flex items-center px-3 gap-[15px]">
                  ...
                  <div>
                    <div
                      class="font-medium text-base leading-8 text-[#000000]"
                    >
                      Campaign 1
                    </div>
                    <div class="text-[#000000] leading-5 text-xs">
                      Sender: John Doe (johndoe@gmail.com)
                    </div>
                    <div class="text-[#767680] leading-5 text-xs">
                      Created On: Dec 01, 2024 | 05:07
                    </div>
                    <div class="flex items-center mt-1">
                      <span
                        class="bg-[#525B8E2E] text-[#525B8E] text-xs px-2 rounded-full"
                      >
                        ES
                      </span>
                    </div>
                    <div
                      class="w-[130px] bg-gray-200 mt-3 rounded-full h-1.5"
                    >
                      <div
              ...
              <td class="py-3 text-center">
                <div class="flex flex-col items-center px-3">
                  ...
                  >
                    <path
                      d="M6.39062 11.1057L11.3906 14.6057L16.3906 11.1057"
                      stroke="black"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
              ...
              <td class="py-3 text-center">
                <div class="flex justify-center space-x-2 px-3">
                  ...
                  <div>
                    ...
                    >
                      <g clip-path="url(#clip0_35_123)">
                        ...
                        />
                        <path
                          d="M8.01566 9.48065H9.89066V11.3557H8.01566V9.48065ZM15.8907 9.48065H17.7657V11.3557H15.8907V9.48065ZM16.748 14.5057C16.4578 15.2377 15.9539 15.8655 15.3018 16.3069C14.6497 16.7484 13.8797 16.9832 13.0922 16.9807H12.6891C11.9016 16.9832 11.1316 16.7485 10.4795 16.307C9.82733 15.8655 9.32335 15.2378 9.03322 14.5057L8.97327 14.3557H7.35791L7.64066 15.0626C8.04425 16.0716 8.74091 16.9365 9.64077 17.5457C10.5406 18.155 11.6024 18.4806 12.6891 18.4807H13.0922C14.1789 18.4806 15.2407 18.155 16.1406 17.5457C17.0404 16.9365 17.7371 16.0716 18.1407 15.0626L18.4234 14.3557H16.8079L16.748 14.5057Z"
                          fill="#75D661"
                        />
                      </g>
                      <defs>
                  ...
                  <!-- <i class="fas fa-frown text-gray-500"> </i> -->
                  <div>
                    <svg
                      width="25"
                      height="25"
              ...
              <td class="py-3 text-center">
                <a
                  class="bg-blue-100 text-[#5EA9F5] font-medium mx-6 px-4 py-1.5 rounded"
                  href="campaign-stats.html"
                >
                  Stats
                </a>
              </td>
            ...
            <tr class="border-gray-200 hover:bg-gray-100">
              ...
              <td class="py-3 text-center">
                <button
                  class="bg-blue-100 text-[#5EA9F5] font-medium px-4 mx-6 py-1 rounded"
                >
                  Stats
                </button>
              </td>
            ...
            <tr class="border-gray-200 hover:bg-gray-100">
              ...
              <td class="py-3 text-center">
                <button
                  class="bg-blue-100 text-[#5EA9F5] font-medium px-4 py-1 mx-6 rounded"
                >
                  Stats
                </button>
              </td>
            ...
            <tr class="border-gray-200 hover:bg-gray-100">
              <td class="py-3 text-left whitespace-nowrap border-r">
                <div class="flex items-center px-3 gap-[15px]">
                  ...
                  >
                    <path
                      d="M32.6917 21.8285L29.4105 18.5473C29.2054 18.3422 28.9272 18.227 28.6372 18.227C28.3472 18.227 28.069 18.3422 27.8639 18.5473L17.6997 28.7115V33.5393H22.5275L32.6917 23.3751C32.8968 23.17 33.012 22.8918 33.012 22.6018C33.012 22.3118 32.8968 22.0336 32.6917 21.8285ZM21.6219 31.3518H19.8872V29.6171L25.356 24.1484L27.0906 25.8831L21.6219 31.3518ZM28.6372 24.3365L26.9025 22.6018L28.6372 20.8671L30.3719 22.6018L28.6372 24.3365ZM8.94971 18.2268H19.8872V20.4143H8.94971V18.2268ZM8.94971 11.6643H22.0747V13.8518H8.94971V11.6643Z"
                      fill="#525B8E"
                    />
                    <path
                      d="M28.6372 5.10181C28.6372 4.52165 28.4067 3.96525 27.9965 3.55501C27.5863 3.14477 27.0299 2.91431 26.4497 2.91431H4.57472C3.99455 2.91431 3.43815 3.14477 3.02792 3.55501C2.61768 3.96525 2.38722 4.52165 2.38722 5.10181V19.3206C2.38466 21.5019 2.97627 23.6427 4.09853 25.5133C5.2208 27.3838 6.83133 28.9133 8.75722 29.9376L14.4185 32.9563V30.4768L9.78753 28.0071C8.21213 27.1686 6.89465 25.9171 5.97633 24.3868C5.05802 22.8566 4.5735 21.1052 4.57472 19.3206V5.10181H26.4497V14.9456H28.6372V5.10181Z"
                      fill="#525B8E"
                    />
                  </svg>
              ...
              <td class="py-3 text-center">
                <button
                  class="bg-blue-100 text-[#5EA9F5] font-medium px-4 py-1 rounded mx-6"
                >
                  Stats
                </button>
              </td>
