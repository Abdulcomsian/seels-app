                ...
                <div class="flex items-center flex-wrap space-x-4">
                    ...
                    <div class="relative">
                        <button id="folderDropdownBtn" class="text-gray-600 flex items-center">
                            ...
                            <span class="pl-[9px] pr-[3px] text-[18px] text-[#000000]">Folders</span>
                            <i class="ri-arrow-drop-down-line text-[18px]"></i>
                        </button>
                        <!-- Dropdown Menu -->
                ...
                <table class="bg-white">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        ...
                        <tr class="border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 text-center">
                                <button class="bg-blue-100 text-[#5EA9F5] font-medium px-4 mx-6 py-1 rounded">
                                    Stats
                                </button>
                            </td>
                        </tr>
                        ...
                        <tr class="border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 text-center">
                                <button class="bg-blue-100 text-[#5EA9F5] font-medium px-4 py-1 mx-6 rounded">
                                    Stats
                                </button>
                            </td>
                        </tr>
                        ...
                        <tr class="border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 text-center">
                                <button class="bg-blue-100 text-[#5EA9F5] font-medium px-4 py-1 rounded mx-6">
                                    Stats
                                </button>
                            </td>
                        </tr>
