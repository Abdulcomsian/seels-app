            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="password mt-4 relative">
                    ...
                    <div class="relative">
                        ...
                        <button type="button"
                            class="absolute top-6 right-3 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 focus:outline-none" id="passwordToggle">
                ...
                <div class="mb-4 w-full flex flex-col md:flex-row lg:items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <div class="relative inline-flex items-center">
                            <input type="checkbox" id="rememberMeSwitch" class="sr-only peer" checked />
                            <div
...
<script>
    ...
    const passwordInput = document.getElementById('password'); // replace with actual input ID
